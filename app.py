# employee DB ক্লিন করার জন্য
#import os
#if os.path.exists("emp.db"): os.remove("emp.db")
# ==============================================================================
...
def render_header():
    ...
    address_html = '<p style="color: #a0a0a0; margin-top: 1px; margin-bottom: 0px; font-size: 13px;">394 Anima Plaza, Nagerbazar, Bagerhat Sadar, Bagerhat.</p>'
        ...
        with st.expander("📥 Excel Upload"):
            ...
            with up_col2:
                ...
                accept_all_dates = st.radio("📅 তারিখ ফিল্টারিং পারমিশন (Your Choice):", 
                                            ["শুধু ড্যাশবোর্ডের তারিখের ডাটা ফিল্টার করে নিন", "যেকোনো তারিখের ডাটা একসাথে গ্রহণ করুন"], 
