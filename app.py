...
def init_db():
    ...
    # ৩. বিবিধ বা ফুটকর খরচ ট্র্যাকিং টেবিল
    cursor.execute('''
...
<style>
    ...
    /* ২. গ্লোবাল ব্লক স্পেসিং ডিফল্ট ১৬px থেকে কমিয়ে ১০px করা (যাতে খুব ঠাসাঠাসি না লাগে) */
...
with st.sidebar:
    ...
    if st.button("📊 ড্যাশবোর্ড ওভারভিউ", use_container_width=True):
        st.session_state.current_page = "Dashboard"
    if st.button("👥 কর্মচারী বা স্টাফ ম্যানেজমেন্ট", use_container_width=True):
            ...
            try:
                ...
                if st.button("🚀 ডাটাবেজে ইম্পোর্ট সম্পন্ন করুন"):
                    ...
                    for index, row in excel_df.iterrows():
                        # এক্সেল রো থেকে ডাটা প্রসেস এবং মিসিং কলাম সেফগার্ড লজিক
...
# ==============================================================================
    ...
    with main_col2:
        st.markdown("""
            <div class="hdr-red" style="margin-bottom: 0px !important;">🛸 PAY OUT (খরচ/প্রدان)</div>
    ...
    # প্লেসহোল্ডার ডেটা রেন্ডারিং (ডামি লজিক ব্যাকআপ)
