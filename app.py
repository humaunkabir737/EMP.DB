...
st.markdown("""
    ...
    .block-container, .stAppViewBlockContainer {
        padding-top: 3rem !important; /* ২ ইঞ্চির গ্যাপ কমিয়ে ১.৫ রেম করা হলো */
    ...
    if uploaded_file:
        try:
            ...
            if st.button("💾 Save"):
                ...
                conn.commit() # সব ডাটা একসাথে লুপের বাইরে এসে ডাটাবেজে সেভ করা (নিরাপদ)
                conn.close()  # কানেকশন লুপের বাইরে এসে ক্লোজ হবে
